...
class Page extends BasePage
{
    public function body_html(): string
    {
        ...
        $theme_name = $config->get_string(SetupConfig::THEME, 'Whiskr');
        ...
        $menu = "<div class='menu'>
			...
			<a href='".make_link()."' onmouseover='Tip(&#39;Home&#39;, BGCOLOR, &#39;#C3D2E0&#39;, FADEIN, 100)' onmouseout='UnTip()'><img alt='' src='{$data_href}/favicon.ico' style='position: relative; top: 3px;'><b>{$site_name}</b></a> ";
